...
func main() {
	...
	out, err := svc.UpdateControlPolicyMapping(ctx, &control_policy.ControlPolicyMapping{
	...
	if err != nil {
		log.Fatalf("Control Monkey: failed to update ControlPolicyMapping: %v", err)
	}

	// Output ControlPolicyMapping, if was updated.
	if out != nil {
