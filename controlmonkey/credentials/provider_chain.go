...
var ErrNoValidProvidersFoundInChain = errors.New("controlmonkey: no valid credentials providers in chain")

// A ChainProvider will search for a provider which returns credentials.
//
// The ChainProvider provides a way of chaining multiple providers together which
// will pick the first available using priority order of the Providers in the read.
//
...
// ChainProvider will check the next Provider in the read, FileProvider in this
...
// An error read that satisfies the error interface.
